...
class Parallax:
    ...
    Color = Property.Color(Color.White)
    Org = Vec3(0, 0, 0)
    ...
    def Initialize(self, initializer):
        ...
        self.Center.Sprite.Color = self.Color
        ...
        self.Right.Transform.WorldTranslation += Vec3(self.Width, 0, 0)
        self.Right.Sprite.SpriteSource = self.Image
        self.Right.Sprite.Color = self.Color
        ...
        self.Left.Transform.WorldTranslation -= Vec3(self.Width, 0, 0)
        self.Left.Sprite.SpriteSource = self.Image
        self.Left.Sprite.Color = self.Color
    ...
    def CheckPlayerLocation(self):
        ...
        if self.Player.Transform.WorldTranslation.x > self.Right.Transform.WorldTranslation.x - self.HalfWidth:
            self.Left.Transform.WorldTranslation = self.Right.Transform.WorldTranslation + Vec3(self.Width * 2, 0, 0)
            temp = self.Left
        ...
        if self.Player.Transform.WorldTranslation.x < self.Left.Transform.WorldTranslation.x + self.HalfWidth:
            self.Right.Transform.WorldTranslation = self.Left.Transform.WorldTranslation - Vec3(self.Width * 2, 0, 0)
            temp = self.Right
