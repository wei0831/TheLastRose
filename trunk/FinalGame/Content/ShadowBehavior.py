...
class ShadowBehavior:
    ...
    IsOwner = False
    OffsetX = Property.Float(0.175)
    HardcodeDistance = Property.Float(3.5)
    ...
    def OnLogicUpdate(self, UpdateEvent):
        if self.IsOwner and self.PlayerShadow.Sprite.Visible :
            ...
            self.PlayerShadow.Transform.WorldScale = Vec3(3.2*(self.HardcodeDistance - distance), self.PlayerShadow.Transform.WorldScale.y, self.PlayerShadow.Transform.WorldScale.z)
