...
class CanFancyDie:
    ...
    NoncollidingGroup = Property.CollisionGroup("Noncolliding")
    CollidingGroup = Property.CollisionGroup("Player")
    ...
    def Die(self):
        ...
        self.Owner.Collider.CollisionGroup = self.NoncollidingGroup
    ...
    def Death_Stage1(self):
        ...
        self.Space.SoundSpace.PlayCue("DeathCue")
    ...
    def GoRespawn(self):
        ...
        if towardVec.length() > 0.1:
            ...
            self.Space.SoundSpace.PlayCue("RespawnCue")
    ...
    def Death_Stage4(self):
        ...
        self.Owner.Collider.CollisionGroup = self.CollidingGroup
